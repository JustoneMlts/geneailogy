...
import { createFeedPost, getPostsByUserId } from "../../controllers/feedController"
...
export default function WallPage() {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            // Récupérer les infos du propriétaire du mur
            const user = await getUserById(id as string)
            setWallOwner(user)

            // Récupérer ses posts
            const posts = await getPostsByUserId(id as string)
            setWallPosts(posts)
        }
